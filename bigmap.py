#!/usr/bin/env python
# Generated by BigMap 2. Permalink: http://bigmap.osmz.ru/bigmap.php?xmin=19328&xmax=19407&ymin=12384&ymax=12431&zoom=15&scale=256&tiles=transport

import io, urllib2, datetime, time, re, random
from PIL import Image, ImageDraw
# ^^^^^^ install "python-pillow" package | pip install Pillow | easy_install Pillow

(zoom, xmin, ymin, xmax, ymax) = (15, 19328, 12384, 19407, 12431)
layers = ["http://{abc}.tile2.opencyclemap.org/transport/!z/!x/!y.png"]
attribution = 'Map data (c) OpenStreetMap, Tiles (c) Andy Allan'
xsize = xmax - xmin + 1
ysize = ymax - ymin + 1
